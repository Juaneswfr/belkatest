...
$image = 'https://test-mas-que-partners.herokuapp.com/assets/media/logo-black.png';
...
if($_GET['option'] == 'blog' ){
    ...
    $image = 'https://test-mas-que-partners.herokuapp.com/assets/media/main-blog-1.jpg';
}
